...
int main() {
    ...
    input_layer[0][0] = 3; // Example input value 1
    input_layer[1][0] = 2; // Example input value 2
    input_layer[2][0] = 5; // Example input value 3
    input_layer[3][0] = 0; // Example input value 4
